...
CREATE TABLE IF NOT EXISTS `playground.demo_profile_values` (
...
CREATE TABLE IF NOT EXISTS `playground.demo_users` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0',
...
ALTER TABLE `playground.demo_profile_values`
 ADD PRIMARY KEY (`id`), ADD KEY `index_value` (`value`(100)), ADD KEY `fid_2` (`fid`,`uid`);

--
-- Indexes for table `demo_users`
--
ALTER TABLE `playground.demo_users`
 ADD PRIMARY KEY (`uid`), ADD UNIQUE KEY `name` (`name`), ADD UNIQUE KEY `mail` (`mail`);
